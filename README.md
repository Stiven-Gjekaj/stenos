...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-585_passing-427819?style=for-the-badge" alt="585 tests passing"/>
</p>
...
| **Commands** | bot.py | 988 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 315 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3928** | Plus 6442 lines of tests |
