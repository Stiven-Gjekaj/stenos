...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-529_passing-427819?style=for-the-badge" alt="529 tests passing"/>
</p>
...
| **Commands** | bot.py | 882 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 305 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3690** | Plus 5949 lines of tests |
