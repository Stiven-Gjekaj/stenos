...
| --- | --- | --- | --- |
| **Receiving** | sink.py | 473 | Places packets on the media clock they carry and splits segments on silence; loads libopus |
...
| **Total** | **11 files** | **3839** | Plus 6214 lines of tests |
