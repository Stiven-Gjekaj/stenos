...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-709_passing-427819?style=for-the-badge" alt="709 tests passing"/>
</p>
...
| **Commands** | bot.py | 1538 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 343 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **12 files** | **5263** | Plus 8414 lines of tests |
