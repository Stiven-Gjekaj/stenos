...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-586_passing-427819?style=for-the-badge" alt="586 tests passing"/>
</p>
...
| **Commands** | bot.py | 998 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 315 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3938** | Plus 6468 lines of tests |
