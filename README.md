...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-607_passing-427819?style=for-the-badge" alt="607 tests passing"/>
</p>
...
| **Commands** | bot.py | 1046 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 323 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **4029** | Plus 6701 lines of tests |
