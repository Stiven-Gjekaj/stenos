...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-669_passing-427819?style=for-the-badge" alt="669 tests passing"/>
</p>
...
| **Commands** | bot.py | 1268 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 333 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **12 files** | **4874** | Plus 7723 lines of tests |
