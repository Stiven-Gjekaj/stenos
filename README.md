...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-502_passing-427819?style=for-the-badge" alt="502 tests passing"/>
</p>
...
| **Commands** | bot.py | 839 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 281 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3598** | Plus 5482 lines of tests |
