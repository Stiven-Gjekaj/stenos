...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-715_passing-427819?style=for-the-badge" alt="715 tests passing"/>
</p>
...
| **Commands** | bot.py | 1582 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 343 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **12 files** | **5307** | Plus 8501 lines of tests |
