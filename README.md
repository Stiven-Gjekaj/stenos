...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-602_passing-427819?style=for-the-badge" alt="602 tests passing"/>
</p>
...
| **Commands** | bot.py | 1019 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 323 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3975** | Plus 6587 lines of tests |
