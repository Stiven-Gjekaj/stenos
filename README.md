...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-506_passing-427819?style=for-the-badge" alt="506 tests passing"/>
</p>
...
| --- | --- | --- | --- |
| **Receiving** | sink.py | 461 | Places packets on the media clock they carry and splits segments on silence; loads libopus |
...
| **Conversion** | audio.py | 293 | Downmixes and resamples to 16 kHz mono, discarding fragments too short to carry speech |
...
| **Total** | **11 files** | **3603** | Plus 5592 lines of tests |
