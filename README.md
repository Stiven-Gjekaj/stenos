...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-604_passing-427819?style=for-the-badge" alt="604 tests passing"/>
</p>
...
| **Transport** | upstream.py | 849 | Repairs the py-cord 2.8.1 defects that lose received audio or end a recording, when they are present |
...
| **Commands** | bot.py | 1022 | Slash commands, session state, the offline pipeline, and the CLI |
| **Configuration** | config.py | 323 | Validated environment parsing and platform-aware backend resolution |
| **Total** | **11 files** | **3993** | Plus 6623 lines of tests |
